...
## Project Structure
    ...
    ├── testapiautoconnect_128786  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_128786`
...
2. Clone this repo and `cd testapiautoconnect_128786`
